...
jsaddleInit jsm evaluateJavascriptAsyncPtr = do
  ...
  unsafeUseAsCString (toStrict jsaddleJs) $ \jsaddleJsData ->
    unsafeUseAsCString (toStrict indexHtml) $ \jsaddleHtmlData -> new $
      NativeCallbacks
        { _nativeCallbacks_jsaddleStart = jsaddleStartPtr
        , _nativeCallbacks_jsaddleResult = jsaddleResultPtr
        , _nativeCallbacks_jsaddleJsData = jsaddleJsData
        , _nativeCallbacks_jsaddleHtmlData = jsaddleHtmlData
        }
