...
main = do
    ...
    doctest [
        ...
        "-i" <> jsaddlePath </> "jsaddle-warp/src-ghc",
        jsaddlePath </> "jsaddle-warp/src/Language/Javascript/JSaddle/Test.hs",
        "-i" <> jsaddlePath </> "jsaddle",
        jsaddlePath </> "jsaddle/src-ghc/Data/JSString/Text.hs",
        jsaddlePath </> "jsaddle/src-ghc/Data/JSString/Internal/Type.hs",
        jsaddlePath </> "jsaddle/src-ghc/GHCJS/Foreign.hs",
        jsaddlePath </> "jsaddle/src-ghc/GHCJS/Foreign/Internal.hs",
        jsaddlePath </> "jsaddle/src-ghc/GHCJS/Internal/Types.hs",
        jsaddlePath </> "jsaddle/src-ghc/GHCJS/Marshal.hs",
        jsaddlePath </> "jsaddle/src-ghc/GHCJS/Marshal/Pure.hs",
        jsaddlePath </> "jsaddle/src-ghc/GHCJS/Marshal/Internal.hs",
        jsaddlePath </> "jsaddle/src-ghc/GHCJS/Prim.hs",
        jsaddlePath </> "jsaddle/src-ghc/GHCJS/Prim/Internal.hs",
        jsaddlePath </> "jsaddle/src-ghc/GHCJS/Types.hs",
        jsaddlePath </> "jsaddle/src-ghc/JavaScript/Array.hs",
        jsaddlePath </> "jsaddle/src-ghc/JavaScript/Array/Internal.hs",
        jsaddlePath </> "jsaddle/src-ghc/JavaScript/Object/Internal.hs",
        ...
        jsaddlePath </> "jsaddle/src/Language/Javascript/JSaddle/Classes/Internal.hs",
        ...
        jsaddlePath </> "jsaddle/src/Language/Javascript/JSaddle/Marshal/String.hs",
        jsaddlePath </> "jsaddle/src/Language/Javascript/JSaddle/Native.hs",
        jsaddlePath </> "jsaddle/src/Language/Javascript/JSaddle/Native/Internal.hs",
